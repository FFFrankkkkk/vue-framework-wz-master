 ...
 },
 {
    ...
    children: [
     ...
     {path: '/components',name: 'component组件',redirect: '/components/buttons',icon:'bookmark',
      ...
      {path: '/markdown',name: '用户管理模块',icon:"person",
          component: {render (c) { return c('router-view') }},
          children: [
          {path: 'hoverbuttons',name: '用户信息管理',icon:'android-list',component: _import('components/HoverButtons')},
          {path: 'alert',name: '查看职能及工作内容',icon:'android-clipboard',component: _import('components/Alert')},
          {path: 'datepicker',name: '注册',icon:'android-person-add',component: _import('components/DatePicker')},
          {path: 'form',name: '注销',icon:'android-close',component: _import('components/Form')},
          {path: 'modal',name: '角色管理',icon:'ios-body',component: _import('components/Modal')},
          {path: 'modal',name: '权限管理',icon:'android-contact',component: _import('components/Modal')},
          {path: 'modal',name: '角色组管理',icon:'person-stalker',component: _import('components/Modal')},
      ]
      },
        {path: '/markdown',name: '智能垃圾桶模块',icon:"ios-trash",
            component: {render (c) { return c('router-view') }},
            children: [
                {path: 'hoverbuttons',name: '智能垃圾桶状态信息',icon:'ios-pulse-strong',component: _import('components/HoverButtons')},
                {path: 'alert',name: '智能垃圾桶接收垃圾情况',icon:'stats-bars',component: _import('components/Alert')}
            ]
        },
        {path: '/markdown',name: '垃圾管理模块',icon:"trash-b",
            component: {render (c) { return c('router-view') }},
            children: [
                {path: 'hoverbuttons',name: '查看垃圾投放情况',icon:'map',component: _import('components/HoverButtons')},
                {path: 'alert',name: '垃圾的趋势分析',icon:'arrow-graph-up-right',component: _import('components/Alert')}
            ]
        }
    ]
  },
